package com.busanit.ch08_acticity.stack
...
import com.busanit.ch08_acticity.databinding.ActivityThreeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.run {
            oneTextView.setOnClickListener {
                ...
                // 그 위의 모든 액티비티를 제거하고 지정한 액티비티를 최상단
                // 홈 화면으로 바로 돌아갈 때 사용
                startActivity(Intent(this@ThreeActivity, OneActivity::class.java)
                    .apply {
