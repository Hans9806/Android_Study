...
import com.busanit.ch08_acticity.databinding.ActivityMainBinding
import com.busanit.ch08_acticity.intent.Intent1Activity
import com.busanit.ch08_acticity.intent.Intent2Activity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            val launcher = registerForActivityResult(contract) {
                Toast.makeText(
                    this@MainActivity, "다른 액티비티 갔다가 돌아왔습니다.",
                    Toast.LENGTH_SHORT
                ).show()
            ...
            button8.setOnClickListener {
                val intent = Intent(this@MainActivity,
                    Intent2Activity::class.java
                )
                intent.putExtra("extra_msg", "Result API 에서 보낸 메시지")
