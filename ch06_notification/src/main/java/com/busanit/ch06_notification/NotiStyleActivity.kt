...
class NotiStyleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button5.setOnClickListener {
            ...
            val person1 = androidx.core.app.Person.Builder()
...
// 메시지 스타일
            builder.setSmallIcon(android.R.drawable.ic_notification_overlay)
                .setContentTitle("받은 편지함 스타일 알람")
                .setStyle(
                    NotificationCompat.MessagingStyle(person1) // 여기서 person1을 사용하거나
                        // 또는 문자열을 사용하여 MessagingStyle을 초기화할 수 있습니다.
                        // NotificationCompat.MessagingStyle("Your Name")
