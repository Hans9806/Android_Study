...
class InsertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.run {
            // 어댑터와 레이아웃매니저 설정
            recylerView.adapter = MyRecyclerAdapter()
            recylerView.layoutManager = LinearLayoutManager(this@InsertActivity)
            ...
            addButton.setOnClickListener {
                ...
                // 어댑터에 데이터 변경사실을 알림
                recylerView.adapter?.notifyDataSetChanged() // 전체 데이터셋 변경
